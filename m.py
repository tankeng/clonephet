...
cl = LINETCR.LINE()
cl.login(token="Eo5nzO7Bz5sppe4wuzD8.7uJiQCu7LT6Cs3pWmhQ2oa.MYi9pU9kqNslP4/LwgmFfMbQC6btrVCQxis2MJ2sIJM=")
cl.loginResult()
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                msg.contentMetadata = {
                                     ...
                                     "STKVER": "100" }
                ki.sendMessage(msg)
            elif msg.text in ["Welcome","ดีคับ","ดีครับ"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "247",
...
#              if msg.from_ in admin:
        ...
        if op.type == 17:
            ...
            cb = Message()
            cb.to = op.param1
            cb.text = cl.getContact(op.param2).displayName + "(◕ᴥ◕)ᵂᴱᴸᶜᵒᵐᵉ(◕ᴥ◕)   .. ยินดีตอนรับค่ะ ..􂜁􀆅note􏿿อย่าลืมปิดแจ้งเตือนด้วยนะคะ􂜁􀆆note􏿿☆°‧°☆．﹒‧°☆．∴°☆﹒﹒‧☆° ☆"
            cl.sendMessage(cb)

        if op.type == 15:
            if op.param2 in Bots:
                return
            cl.sendText(op.param1, "􀄃􀉓บาย􏿿 บ๊าย บาย 􀄃􀉓บาย􏿿 ดูแลตัวเองดีดีนะ คนที่อยู่ทางนั้น คนทางนี้ยังคิดถึงกัน เหมือนอย่างเดิมไม่เคยเปลี่ยน")
            print "MemberLeft"
