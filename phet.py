...
cl = LINETCR.LINE()
cl.login(token="EpFub0GlkLVkkdCC6cNa.apGNZMzba418M2CeQxD9/G.D1ybusYXxWo1NuJ6N3T/IfgxOUSPBL20g4EB/Q3z8pU=")
cl.loginResult()

ki1 = LINETCR.LINE() #ได้
ki1.login(token="EpPwRXCUGcGKQLUHAzq6.pXN+7RvYi/ufIldOHYCunG.YkzZZgKFpwWp65hy9Qj7U/Y1n2cX+blZnUN0dvDQOX8=")
ki1.loginResult()

ki2 = LINETCR.LINE() #ได้
ki2.login(token="Ep7PN2gw96yqj0gv2kdb.QGfPOYoWMry0tHUk7ByfsW.bSz1mPMzysJnYpGOZ3/Rm0OqzM2y0pGGNyfDUAumErs=")
ki2.loginResult()

ki3 = LINETCR.LINE() #ได้
ki3.login(token="EpfUfa44KA0fqKEavFn0.wr8xgcuZEfwwnOv8gP+n0a.APZ9k5bbOaHA8rlWq1DJ19rtAVwGZTx9jDRFi7xK6DQ=")
ki3.loginResult()

ki4 = LINETCR.LINE() #ได้
ki4.login(token="EpXnUm7WhQhdLjbaxl9f.UTvwOPYi0sJi3oXTG6tPRW.2ZzoPPIJ7Klv3wxPdv34xmrfAYJuiBW+ya8puHjCHZA=")
ki4.loginResult()

ki5 = LINETCR.LINE() #ได้
ki5.login(token="Ep9eKmOqjugEoJZvhOb5.6BDfmN53HxXiA9R9UVF9fq.wZdk/VUMxB7KEj1h2+hI1w9Brd42dFS2hurAjkFDE0Y=")
ki5.loginResult()

ki6 = LINETCR.LINE() #ได้
ki6.login(token="Ep9VhQWaMCyIR64npL7b.5lF7KrBwbqurrYqk5Y36MW.TII0EIiU94RXS2VKJXeuoksEuBcorrQInIT/qbD0ZQw=")
ki6.loginResult()

ki7 = LINETCR.LINE() #ได้
ki7.login(token="Ep7iNJeiOdXZ5pg7N1u2.h5edYb4WKUebl+MD5E8YeG.LutmG9Vhqw8eeMMGjcX8Fwf0d1NnxgsxQ/TEva9cltc=")
ki7.loginResult()

ki8 = LINETCR.LINE() #ได้
ki8.login(token="EpDhYvEJ6cTVbYry0Kza.SX60wgET94co6b9Wft29EG.C4e7MrQKeDtBzWNX9kTXMgoDY5U5iP/XgoScFeFsDRo=")
ki8.loginResult()

ki9 = LINETCR.LINE() #ได้
ki9.login(token="Ep4hZEex8IV3BwScONA5.a/E72xtl+Jd06LlO7U+Wzq.7lyYOqM+MA6UzU2y/XmiP+EffeHsw+k1mPH5fzR1gGY=")
ki9.loginResult()

ki10 = LINETCR.LINE() #ได้
ki10.login(token="EpPag9RslLaT9HYTIkC8.0nlLM2HZeeYQt0PUpMcqsa.N4+0B6T80RWqXQ0Uk77cHOLKOwNUx8wdnL/9GVGfBMg=")
ki10.loginResult()
...
set:addblacklist
บัญชีดำแบ็คลิสคนไม่ให้เข้ากลุ่มส���่งแล้�����ส่งคอลแทคคนที่เราจะแบ็คลิสลงในกลุ่ม
➖➖➖➖➖➖➖➖➖➖➖➖➖➖
