...
cl = LINETCR.LINE()
cl.login(token="EpynLItQsLcwoc8Ic9la.apGNZMzba418M2CeQxD9/G.9rYB5hsgiQA5gjVj/HzTmfM8sd70Ht92vqY9yv14zwk=")
cl.loginResult()

ki1 = LINETCR.LINE() #ได้
ki1.login(token="EpkLa6c2JNhbShWEA53e.5vMR8+Ykfm0HFDJXUvDCVG.5Sn1h9Cq5ybJCFq492DtLGub+eev9+J8erCJL/DP44s=")
ki1.loginResult()

ki2 = LINETCR.LINE() #ได้
ki2.login(token="Ep5DzrVhd7LsGhdTz6K5.ZSwzqufehcQdrqknvOrfvq./eZw8cDbsdmr9NZZcGCDpUvawA0KFnbkyIgKXAwfKgc=")
ki2.loginResult()

ki3 = LINETCR.LINE() #ได้
ki3.login(token="EpLALvKvFreP0NcKZ6r6.XCmcOQSPbzqFrYPbR1cnjG.HlXG1sBvomlBWhAqRw4fvL9XZbbGITN9kp+cXSSHd/o=")
ki3.loginResult()

ki4 = LINETCR.LINE() #ได้
ki4.login(token="EpV3uo6D08yHMffqxrn0.DoyswDNocTiowB6sSzUAia.Qz0RsleXtMuxkwR72ADdYWOmdARbe4kG8dFtV5Zs36Y=")
ki4.loginResult()

ki5 = LINETCR.LINE() #ได้
ki5.login(token="Ep1qh1157xopGIIdpbz5.WyCUMW5PKPZr/QSdM0ZLPq.IIfj9fdOhwpSi1r7CAuq0zpUc0yDBDbd7VbntOHbH+0=")
ki5.loginResult()

ki6 = LINETCR.LINE() #ได้
ki6.login(token="EpDBpp3pWBbRae4Jt0u1.fwi0gAX4tHcuPJXtE/8Feq.rdCfxwj7J7Upkdx4p1GqXSEQAMz9Y0xd3dAE+TG+o18=")
ki6.loginResult()

ki7 = LINETCR.LINE() #ได้
ki7.login(token="EpoXHMjxHflNJukBPRGd.RPnZlQm99q19hqUvFFGRNq.saJBBWZ5V9wIODtRniifAiUbJ7aweN4rOpb+QaLAj3k=")
ki7.loginResult()

ki8 = LINETCR.LINE() #ได้
ki8.login(token="EpTmQRJTKsaOdE67elf2.BuAMRuaWcPiSenL67D6xaG.ekpQmfO/93NcOOh+f+7EJsgW7HwcNG5SGukqTxvnYVY=")
ki8.loginResult()

ki9 = LINETCR.LINE() #ได้
ki9.login(token="Ep7paFBa1nENImNA6Xgc.VCVmtawEUS1xqwm2xs4BJa.0ZRaRZw89BPZahpWUk2BwsU7+qwyU5wwaGCa/M68YVk=")
ki9.loginResult()

ki10 = LINETCR.LINE() #ได้
ki10.login(token="EpKouBLPpAc2gtVEKfJ9.WnjGZSPUZHznwrxhODj6Mq.4mV2bin/ABSe20cwDW4hP/TW/1oKbEjKZoqszt2fQI0=")
ki10.loginResult()
